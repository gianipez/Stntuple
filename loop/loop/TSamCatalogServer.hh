#ifndef TSamCatalogServer_hh
#define TSamCatalogServer_hh
...
class TSamCatalogServer: public TStnCatalogServer {
//-----------------------------------------------------------------------------
//  data members
//-----------------------------------------------------------------------------
protected:
...
//-----------------------------------------------------------------------------
public:
  TSamCatalogServer(const char* Server = "html://nowhere.fnal.gov/cdf/nodir",
		     const char* Rsh    = "rsh -N",
		     int         Print  = 0);

  virtual ~TSamCatalogServer();
